...
# Code taken and modified from: stackoverflow.com/questions/9494739/48775936#48775936
...
if __name__ == '__main__':
    ...
    menu_options = (('Expand', next(icons), runUibb),
                    ('Switch Icon', None, switch_icon))

    SysTrayIcon(next(icons), hover_text, menu_options, default_menu_index=1)
